...
class Comments extends Component {
  ...
  onAddComment = event => {
    ...
    const newComment = {
      ...
      date: new Date(), // Adding date property to the comment object
      isLiked: false,
      ...
      <div className="appContainer">
        <div className="commentsContainer">
          ...
          <div className="addComments">
            <form className="inputComments" onSubmit={this.onAddComment}>
          ...
          <ul className="listContainer">{this.renderCommentsList()}</ul>
        </div>
      </div>
    )
  }
